			...
			columns: [
				{
					...
					template: function() {
						return '\
						<a href="/admin/product/edit-product" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit details">\
							<i class="la la-edit"></i>\
						</a>\
						<a href="/admin/product/delete-product" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete">\
